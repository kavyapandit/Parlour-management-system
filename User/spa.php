...
<?php
                    $ret=mysqli_query($con,"select * from  service where s_id=11");
                        $cnt=1;
    ...
    <?php
                $ret=mysqli_query($con,"select * from  service where s_id=12");
                    $cnt=1;
                    while ($row=mysqli_fetch_array($ret)) {
                    ?>
        <div class="col pb-5 ">
    ...
    <?php
                    $ret=mysqli_query($con,"select * from  service where s_id=13");
                        $cnt=1;
                        while ($row=mysqli_fetch_array($ret)) {
                        ?>
            <div class="col pb-5 ">
    ...
    <?php
                    $ret=mysqli_query($con,"select * from  service where s_id=14");
                        $cnt=1;
                        while ($row=mysqli_fetch_array($ret)) {
                        ?>
            <div class="col pb-5 ">
