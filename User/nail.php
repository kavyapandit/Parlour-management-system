...
<?php
                    $ret=mysqli_query($con,"select * from  service where s_id=17");
                        $cnt=1;
                        while ($row=mysqli_fetch_array($ret)) {
                        ?>
            <div class="col">
                <div class="card border-dark">
                    <img src="images/<?php echo $row['s_img']?>" alt="product" height="200" width="1012" class="img-responsive about-me">
                    <div class="card-body">
