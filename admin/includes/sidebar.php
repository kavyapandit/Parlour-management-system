  <div class=" sidebar" role="navigation">
    ...
    <li>
            ...
            <li>
                    <a href="view-order.php"><i class="fa fa-check-square-o nav_icon"></i>Products<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                      <li>
                        <a href="view-order.php">View Orders</a>
                      </li>
                      <li>
                        <a href="update-product.php">Add Products</a>
                      </li>
                      <li>
                        <a href="all-product.php">Manage Products</a>
                      </li>
                    </ul>
                  </li>

                  <li>
                    <a href="student.php"><i class="fa fa-check-square-o nav_icon"></i>Course<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                      <li>
                        <a href="student.php">Registered Students</a>
                      </li>
                      <li>
                        <a href="add-course.php">Add Course</a>
                      </li>
                      <li>
                        <a href="all-course.php">Manage Course</a>
                      </li>
                    </ul>
                  </li>
                  ...
                  <li>
                    <a href=""><i class="fa fa-check-square-o nav_icon"></i>Payment<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                      <li>
                        <a href="">All Payements</a>
                      </li>
                    </ul>
                  </li>
