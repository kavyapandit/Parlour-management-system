...
?>
						 ...
						 <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['AptNumber'];?></td>
						  ...
						  <td><?php  echo $row['bk_time'];?></td><?php if($row['bk_status']==""){ ?>
