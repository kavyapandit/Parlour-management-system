...
move_uploaded_file($_FILES["image"]["tmp_name"],"images/".$newimage);
 ...
 $eid=$_GET['lid'];
    ...
    $query=mysqli_query($con, "update  product set pr_image='$newimage' where pr_id='$eid' ");
    if ($query) {
...
?> 
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Service Name</label> <input type="text" class="form-control" id="proname" name="proname" placeholder="Product Name" value="<?php  echo $row['pr_name'];?>" readonly="true"> </div>
