	...
	if(isset($_POST['submit']))
	{
		...
		else
		{
			...
			move_uploaded_file($_FILES["image"]["tmp_name"],"images/".$newimage);
				...
				$query=mysqli_query($con, "insert into service(s_name,sc_id,s_description,s_img,s_price) value('$sername','$sercid','$serdesc','$newimage','$cost')");
				if ($query) 
				{
...
<body class="cbp-spmenu-push">
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Service Name</label> <input type="text" class="form-control" id="sername" name="sername" placeholder="Service Name" value="" required="true" pattern="[a-zA-Z ]+" title="Please enter a valid name (letters and spaces only)"> </div>
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Service category Id</label> <input type="number" class="form-control" id="scid" name="scid" value="" required="true"> </div>
