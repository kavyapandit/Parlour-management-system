...
move_uploaded_file($_FILES["image"]["tmp_name"],"images/".$newimage);
 ...
 $eid=$_GET['lid'];
    ...
    $query=mysqli_query($con, "update  service set s_img='$newimage' where s_id='$eid' ");
    if ($query) {
...
?> 
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Service Name</label> <input type="text" class="form-control" id="sername" name="sername" placeholder="Service Name" value="<?php  echo $row['s_name'];?>" readonly="true"> </div>
							 
							 <div class="form-group"> <label for="exampleInputPassword1">Old Image</label>  <img src="images/<?php echo $row['s_img']?>" width="120">
               </div>
