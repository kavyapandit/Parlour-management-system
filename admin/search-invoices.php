...
$ret=mysqli_query($con,"select distinct  customer_registration.cust_name,invoice.BillingId,date(invoice.PostingDate) as invoicedate from  customer_registration   
	join invoice on customer_registration.cust_id=invoice.cust_id  where invoice.BillingId like '%$sdata%' || customer_registration.phone like '%$sdata%' || customer_registration.cust_name like '%$sdata%'");
